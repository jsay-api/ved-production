"""
Django settings for vedomosti2 project.
...
SECRET_KEY = 'q=f+dg5bl_ouf54jc2e4h8_x9@^)+l(=q#ll*r96yst8!pax31'
...
WSGI_APPLICATION = 'vedomosti2.wsgi.application'
